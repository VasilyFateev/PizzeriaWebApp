...
using PizzeriaAuthorizationService;
...
namespace PizzeriaAuthorizationService.Migrations
{
    ...
    [Migration("20250509055340_CreateAccountDatabase")]
    partial class CreateAccountDatabase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AccountsModelClasses.User", b =>
                {
                    ...
                    b.Property<string>("CachedPasssword")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("cached_passsword");
